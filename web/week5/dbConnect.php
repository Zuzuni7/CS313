...
function get_db() {
    ...
    try {
        ...
        if (!isset($dbUrl) || empty($dbUrl)) {
            ...
            // $dbUrl = "postgres://uctiofnapfxdol:fe50de79fa1f9ca67ab4b2cdfa94e77e40af3359baae9296d0653254ec0371c6@ec2-54-235-92-43.compute-1.amazonaws.com:5432/dsil8r9hbiei9";
        ...
        $db = new PDO("pgsql:host=$dbHost;port=$dbPort");
