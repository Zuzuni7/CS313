    ...
    <body background="assign03/bg2.jpg" class="center">
        ...
        <div class="relative" ;>
            ...
            <p style="color: black; font: 15px century">
                ...
                Founded in 2018 by Shalom Sims, Rodie's Inc. is
        ...
        <div class="img.a">
            <a href="bikelisting.html"> Classic Bike Parts</a>
            <img class="left" src="assign03/bikedeco2.jpg" />

        </div>

        <div class="img.a">
            <img src="assign03/bikedeco4.jpg" />
        </div>
